...
<head>
  ...
  <script src="<?=BASE?>/vendor/datatables/dataTables.bootstrap4.min.js"></script>
    ...
    <script src="<?=BASE?>/vendor/datepicker/bootstrap-datepicker.js"></script>
<link href="<?=BASE?>/vendor/datepicker/datepicker3.css" rel="stylesheet">
    ...
    <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; KPOWER. <?=date("Y");?></span>
          </div>
        </div>
      </footer>
...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=BASE?>">
  ...
  <img src="<?=BASE?>/img/icon.png" style="width:40px;" alt="">
  </div>
...
<li class="nav-item">
  <a class="nav-link" href="<?=BASE?>/sub-divisions">
    <i class="fas fa-fw fa-bookmark"></i>
    <span>Sub Divisions</span></a>
</li>

<li class="nav-item" hidden>
  <a class="nav-link" href="<?=BASE?>/subjects">
    <i class="fas fa-fw fa-book"></i>
    <span>Subjects</span></a>
</li>

<li class="nav-item">
  <a class="nav-link" href="<?=BASE?>/transactions">
    <i class="fas fa-fw fa-table"></i>
    <span>Bill Payments</span></a>
</li>
...
<!-- Nav Item - Charts -->
<li class="nav-item">
  <a class="nav-link" href="<?=BASE?>/notifications">
...
<!--<li class="nav-item">-->
<!--  <a class="nav-link" href="<?=BASE?>/activity-log">-->
...
<ul class="navbar-nav ml-auto">
  ...
  <li class="nav-item dropdown no-arrow">
    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?=$_SESSION['sessionuser']?></span>
      <img class="img-profile rounded-circle" src="<?=BASE?>/img/no-profile-photo.jpg">
    </a>
    ...
    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
      ...
      <a class="dropdown-item" href="<?=BASE?>/activity-log">
